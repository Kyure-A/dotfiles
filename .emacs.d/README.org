...
#+begin_src emacs-lisp 
  ...
  (with-delayed-execution
    ...
    (autoload-if-found '(typescript-mode typescript-tsx-mode) "typescript-mode")
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'eglot
    (add-to-list 'eglot-server-programs '((js-mode typescript-mode web-mode) . es-server-program))
